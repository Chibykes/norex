...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    // 0 - Rates Updated Successfully
    // 1 - Downloading New Rates
  ...
  useEffect(() => {
    const timeout = setTimeout(() => setDownloading(null),2000);
    ...
    <div className="">
      ...
      {downloading !== null && 
        <div className="fixed top-4 left-0 right-0 grid place-content-center">
          <div className={`inline-flex justify-center items-center gap-2 mx-auto p-2 ${
            downloading === 0 ? "bg-green-600":
